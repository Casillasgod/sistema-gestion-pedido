"""
Archivo : test_inventario.py
Descripción: Pruebas unitarias para el patrón Adapter (AdapterInventario).
             Verifica que el Adapter implementa la interfaz Target, que
             traduce correctamente nombres de producto a SKUs, y que el
             código cliente es independiente del sistema legado.
...
"""
import pytest
from src.inventario.inventario import (FuenteInventario, SistemaInventarioLegacy,
                                        AdapterInventario)
