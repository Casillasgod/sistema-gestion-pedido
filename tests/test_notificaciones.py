"""
Archivo : test_notificaciones.py
Descripción: Pruebas unitarias para el patrón Bridge (Notificacion × Canal).
             Verifica que cualquier abstracción funciona con cualquier canal,
             el intercambio de canal en tiempo de ejecución, la extensibilidad
             sin modificar clases existentes, y todas las combinaciones
             via parametrize.
...
# ── Abstracción funciona con cualquier canal ──
...
# ── Cambio de canal en tiempo de ejecución ──
...
# ── Agregar un canal nuevo no modifica las abstracciones ──
...
# ── parametrize: verificar todas las combinaciones ──
