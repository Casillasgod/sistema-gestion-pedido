...
Descripción: Pruebas unitarias para el patrón Abstract Factory (PasarelaPago).
             Verifica que cada fábrica produce la familia correcta de productos,
             que las familias no se mezclan, y que el entorno de pruebas
