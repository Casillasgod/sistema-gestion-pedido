"""
Archivo : test_observer.py
Descripción: Pruebas unitarias para el patrón Observer (GestorPedidos).
             Verifica que todos los suscriptores reciben las notificaciones,
             que el historial de auditoría se actualiza correctamente, que
             los observadores pueden desuscribirse, y que el sujeto lanza
             error con pedidos no registrados.
