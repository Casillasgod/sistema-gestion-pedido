"""
Archivo : test_builder.py
Descripción: Pruebas unitarias para el patrón Builder (PedidoBuilder).
             Verifica la interfaz fluida, el cálculo de totales,
             las validaciones y la unicidad de número de pedido.
