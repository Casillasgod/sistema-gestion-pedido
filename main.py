"""
Archivo : main.py
Descripción: Punto de entrada del sistema. Demuestra la integración de
             todos los patrones implementados en el proyecto: Singleton
             (configuración), Builder (pedido), Strategy (descuento),
             Abstract Factory (pasarela de pago), Adapter (inventario),
             Observer (estado del pedido) y Bridge (notificaciones).
Patrones : Singleton, Builder, Strategy, Abstract Factory,
             Adapter, Observer, Bridge
